...
export default function appChose() {
    return(
        <div className="w-screen h-screen bg-black flex justify-center items-center gap-[1rem]">
            <a href="https://faculdade-projeto.vercel.app" target="blank">
                <div className="w-[30rem] h-[30rem] border-solid border-[0.3rem] border-purple-600 rounded-[1rem] scale-[90%] flex justify-center items-center hover:scale-[100%] transition-[0.1s] cursor-pointer">
                    <Image 
                        src={logo}
                        width={250}
                        height={250}
