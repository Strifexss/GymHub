...
export default function oQuee() {
    return(
        <div id="oQuee" className="md:h-auto 2xl:h-screen h-auto w-screen md:flex flex-col items-center md:pl-[10rem] md:pr-[10rem] 2xl:pl-[20rem] 2xl:pr-[20rem] justify-center bg-white">
            <h1 className=" m-3 mt-12 text-black text-[2rem] md:text-[2rem] 2xl:text-[3rem] text-center font-bold">
